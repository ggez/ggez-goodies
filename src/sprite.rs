...
impl<'a> graphics::Drawable for Sprite<'a> {
    fn draw_ex(&self, context: &mut ggez::Context, src: Option<graphics::Rect>, dst: Option<graphics::Rect>, angle: f64, center: Option<graphics::Point>, flip_horizontal: bool, flip_vertical: bool) -> ggez::GameResult<()> {
       Ok(())
    }
}
